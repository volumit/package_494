...
#ifdef WITH_HIGHTEC
  fputs (_("  -ferror-numbers          Add unique number for each error and warning message.\n"), stdout);
#endif /* WITH_HIGHTEC */
...
main (int argc, char **argv)
{
...
#ifdef WITH_HIGHTEC
  {
    ...
    init_locale_dir (decoded_options[0].arg, canonical);
...
const char *
insert_tooldir_spec_function (int argc, const char **argv)
{
  char *pdir;
