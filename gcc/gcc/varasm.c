...
section *
default_htc_get_named_section (tree decl, const char *name, int reloc)
{
  unsigned int flags;
...
{
  return targetm.htc.get_named_section (decl, name, reloc);
}
...
bool
default_htc_bss_initializer_p (const_tree decl)
{
...
{
  return targetm.htc.bss_initializer_p (decl);
}
