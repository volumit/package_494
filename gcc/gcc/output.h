...
extern void default_htc_resolve_unique_section (tree, int, int);
extern section* default_htc_get_named_section (tree, const char*, int);
extern bool default_htc_bss_initializer_p (const_tree);
