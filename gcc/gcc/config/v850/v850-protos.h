...
/* HTC specific modifications */

extern v850_section_t *v850_pragma_section_code;
extern v850_section_t *v850_pragma_section_data;

extern v850_section_t * v850_insert_section (const char *, const char*, unsigned int, location_t);
extern void v850_pragma_section (struct cpp_reader *);

extern int v850_used_pragma;
