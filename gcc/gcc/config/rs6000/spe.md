...
(define_insn "smaxsf3_gpr"
  [(set (match_operand:SF 0 "gpc_reg_operand" "=r")
	(smax:SF (match_operand:SF 1 "gpc_reg_operand" "r")
		 (match_operand:SF 2 "gpc_reg_operand" "r")))]
  "TARGET_HARD_FLOAT && TARGET_EFPU"
  "efsmax %0,%1,%2"
  [(set_attr "type" "fpsimple")])

(define_insn "sminsf3_gpr"
  [(set (match_operand:SF 0 "gpc_reg_operand" "=r")
	(smin:SF (match_operand:SF 1 "gpc_reg_operand" "r")
		 (match_operand:SF 2 "gpc_reg_operand" "r")))]
  "TARGET_HARD_FLOAT && TARGET_EFPU"
  "efsmin %0,%1,%2"
  [(set_attr "type" "fpsimple")])

(define_insn "*maddsf4_gpr"
  [(set (match_operand:SF 0 "gpc_reg_operand" "=r")
	(plus:SF (mult:SF (match_operand:SF 1 "gpc_reg_operand" "r")
                     (match_operand:SF 2 "gpc_reg_operand" "r"))
             (match_operand:SF 3 "gpc_reg_operand" "0")) )]
  "TARGET_HARD_FLOAT && TARGET_EFPU"
  "efsmadd %0,%1,%2"
  [(set_attr "type" "fpsimple")])

(define_insn "*msubsf4_gpr"
  [(set (match_operand:SF 0 "gpc_reg_operand" "=r")
	(minus:SF (mult:SF (match_operand:SF 1 "gpc_reg_operand" "r")
                     (match_operand:SF 2 "gpc_reg_operand" "r"))
             (match_operand:SF 3 "gpc_reg_operand" "0")) )]
  "TARGET_HARD_FLOAT && TARGET_EFPU"
  "efsmsub %0,%1,%2"
...
(define_insn "*nmaddsf4_gpr"
  [(set (match_operand:SF 0 "gpc_reg_operand" "=r")
	(neg:SF(plus:SF (mult:SF (match_operand:SF 1 "gpc_reg_operand" "r")
                     (match_operand:SF 2 "gpc_reg_operand" "r"))
             (match_operand:SF 3 "gpc_reg_operand" "0"))) )]
  "TARGET_HARD_FLOAT && TARGET_EFPU"
  "efsnmadd %0,%1,%2"
...
(define_insn "*nmsubsf4_gpr"
  [(set (match_operand:SF 0 "gpc_reg_operand" "=r")
	(neg:SF(minus:SF (mult:SF (match_operand:SF 1 "gpc_reg_operand" "r")
                     (match_operand:SF 2 "gpc_reg_operand" "r"))
             (match_operand:SF 3 "gpc_reg_operand" "0"))) )]
  "TARGET_HARD_FLOAT && TARGET_EFPU"
  "efsnmsub %0,%1,%2"
...
(define_insn "cmptfeq_gpr"
  ...
  "!TARGET_IEEEQUAD
   && TARGET_HARD_FLOAT && TARGET_E500_DOUBLE && TARGET_LONG_DOUBLE_128
   && !(flag_finite_math_only && !flag_trapping_math)"
  "efdcmpeq %0,%1,%2\;bng %0,0f\;efdcmpeq %0,%L1,%L2\;0:\;"
  [(set_attr "type" "veccmp")
   (set_attr "length" "12")])
...
(define_insn "tsttfeq_gpr"
  ...
  "!TARGET_IEEEQUAD
   && TARGET_HARD_FLOAT && TARGET_E500_DOUBLE && TARGET_LONG_DOUBLE_128
   && flag_finite_math_only && !flag_trapping_math"
  "efdtsteq %0,%1,%2\;bng %0,0f\;efdtsteq %0,%L1,%L2\;0:\;"
  [(set_attr "type" "veccmpsimple")
   (set_attr "length" "12")])
...
(define_insn "cmptfgt_gpr"
  ...
  "!TARGET_IEEEQUAD
   && TARGET_HARD_FLOAT && TARGET_E500_DOUBLE && TARGET_LONG_DOUBLE_128
   && !(flag_finite_math_only && !flag_trapping_math)"
  "efdcmpgt %0,%1,%2\;bgt %0,0f\;efdcmpeq %0,%1,%2\;bng %0,0f\;efdcmpgt %0,%L1,%L2\;0:\;"
  [(set_attr "type" "veccmp")
   (set_attr "length" "20")])
...
(define_insn "tsttfgt_gpr"
  ...
  "!TARGET_IEEEQUAD
   && TARGET_HARD_FLOAT && TARGET_E500_DOUBLE && TARGET_LONG_DOUBLE_128
   && flag_finite_math_only && !flag_trapping_math"
  "efdtstgt %0,%1,%2\;bgt %0,0f\;efdtsteq %0,%1,%2\;bng %0,0f\;efdtstgt %0,%L1,%L2\;0:\;"
  [(set_attr "type" "veccmpsimple")
   (set_attr "length" "20")])
...
(define_insn "cmptflt_gpr"
  ...
  "!TARGET_IEEEQUAD
   && TARGET_HARD_FLOAT && TARGET_E500_DOUBLE && TARGET_LONG_DOUBLE_128
   && !(flag_finite_math_only && !flag_trapping_math)"
  "efdcmplt %0,%1,%2\;bgt %0,0f\;efdcmpeq %0,%1,%2\;bng %0,0f\;efdcmplt %0,%L1,%L2\;0:\;"
  [(set_attr "type" "veccmp")
   (set_attr "length" "20")])
...
(define_insn "tsttflt_gpr"
  ...
  "!TARGET_IEEEQUAD
   && TARGET_HARD_FLOAT && TARGET_E500_DOUBLE && TARGET_LONG_DOUBLE_128
   && flag_finite_math_only && !flag_trapping_math"
  "efdtstlt %0,%1,%2\;bgt %0,0f\;efdtsteq %0,%1,%2\;bng %0,0f\;efdtstlt %0,%L1,%L2\;0:\;"
  [(set_attr "type" "veccmpsimple")
   (set_attr "length" "20")])
