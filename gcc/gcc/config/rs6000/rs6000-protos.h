...
/* HighTec extension */
extern int ppcvle_expand_block_move (rtx operands[]);
extern int ppcvle_expand_block_clear (rtx operands[]);
#endif /* RTX_CODE */
...
extern bool ppcvle_libc_has_function (enum function_class fn_class);
extern bool ppcvle_valid_sci8(unsigned HOST_WIDE_INT value);
extern void ppc_asm_output_external (FILE *file, tree decl, const char *name);
#ifdef TREE_CODE
extern void ppc_asm_declare_object_name(FILE *asm_file, const char *name, tree decl);
#endif


#ifdef TREE_CODE
extern void ppcvle_asm_output_aligned_block_local (FILE*, tree, const char*, HOST_WIDE_INT, unsigned int);
#endif
extern bool ppcvle_sat_operator_match (rtx, rtx, int *, bool *);
