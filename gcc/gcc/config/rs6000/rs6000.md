...
(define_c_enum "unspec"
  [UNSPEC_FRSP			; frsp for POWER machines
   ...
   UNSPEC_LSQ
   UNSPEC_FUSION_GPR
   UNSPEC_NAKED     ; naked function return
   UNSPEC_CODE_PIC_ADDR
  ])
...
;; computations.
(define_attr "type" "integer,two,three,load,load_ext,load_ext_u,load_ext_ux,load_ux,load_u,store,store_ux,store_u,fpload,fpload_ux,fpload_u,fpstore,fpstore_ux,fpstore_u,vecload,vecstore,imul,imul2,imul3,lmul,idiv,ldiv,insert_word,branch,cmp,fast_compare,compare,var_delayed_compare,delayed_compare,imul_compare,lmul_compare,fpcompare,cr_logical,delayed_cr,mfcr,mfcrf,mtcr,mfjmpr,mtjmpr,fp,fpsimple,dmul,sdiv,ddiv,ssqrt,dsqrt,jmpreg,brinc,vecsimple,veccomplex,vecdiv,veccmp,veccmpsimple,vecperm,vecfloat,vecfdiv,vecdouble,isync,sync,load_l,store_c,shift,trap,insert_dword,var_shift_rotate,cntlz,exts,mffgpr,mftgpr,isel,memcpy,load_n,store_n,satmul,popcnt,crypto,htm"
...
(define_attr "cpu"
  "ppc601,ppc603,ppc604,ppc604e,ppc620,ppc630,
   ...
   ppce200zx,ppcz225n3,ppcz410n3,ppcz420n3,ppcz425n3,ppcz425Bn3,ppcz710n3,ppcz720n3"
...
;; define cpu specific insn alternatives
(define_attr "cpu_facility" "standard,vle,novle"
  (const_string "standard"))

(define_attr "enabled" ""
  (cond [(eq_attr "cpu_facility" "standard") (const_int 1)
         (and (eq_attr "cpu_facility" "vle")
              (ne (symbol_ref "TARGET_VLE") (const_int 0)))
         (const_int 1)
         (and (eq_attr "cpu_facility" "novle")
              (eq (symbol_ref "TARGET_VLE") (const_int 0)))
         (const_int 1)
        ]
  (const_int 0)))
...
(define_code_attr return_pred [(return "direct_return ()")
			       (simple_return "1")])
(define_code_attr novle_return_pred [(return "!TARGET_VLE && direct_return ()")
			       (simple_return "1")])
...

;; Saturation insns
(include "ppcvle-sat.md")
(include "ppcvle-byte-short.md")
...
(define_insn "*add<mode>3_internal1"
  [(set (match_operand:GPR 0 "gpc_reg_operand" "=r,r,r,?r,r,r")
	(plus:GPR (match_operand:GPR 1 "gpc_reg_operand" "%r,b,r,r,b,0")
		  (match_operand:GPR 2 "add_operand" "r,I,wDI,I,L,L")))]
  ...
  [(set_attr "length" "4,4,4,4,4,4")
   (set_attr "cpu_facility" "*,*,vle,novle,*,vle")])
...
(define_insn "*add<mode>3_internal2"
  [(set (match_operand:CC 0 "cc_reg_operand" "=x,x,x,?y,?y")
	(compare:CC (plus:P (match_operand:P 1 "gpc_reg_operand" "%r,r,r,r,r")
			    (match_operand:P 2 "reg_or_short_operand" "r,I,wDI,r,I"))
		    (const_int 0)))
   (clobber (match_scratch:P 3 "=r,r,r,r,r"))]
  ""
  "@
   add. %3,%1,%2
   addic. %3,%1,%2
   ...
   #
   #"
  [(set_attr "type" "fast_compare,compare,compare,compare,compare")
   (set_attr "length" "4,4,4,8,8")
   (set_attr "cpu_facility" "*,novle,vle,*,*")])
...
(define_insn "*add<mode>3_internal3"
  [(set (match_operand:CC 3 "cc_reg_operand" "=x,x,x,?y,?y,?y")
	(compare:CC (plus:P (match_operand:P 1 "gpc_reg_operand" "%r,r,r,r,r,r")
			    (match_operand:P 2 "reg_or_short_operand" "r,I,wD,r,I,wD"))
		    (const_int 0)))
  ...
  [(set_attr "type" "fast_compare,compare,compare,compare,compare,compare")
   ...
   (set_attr "cpu_facility" "*,novle,vle,*,novle,vle")])
...
(define_insn ""
  [(set (match_operand:GPR 0 "gpc_reg_operand" "=r,r,r")
	(minus:GPR (match_operand:GPR 1 "reg_or_short_operand" "r,I,wD")
		   (match_operand:GPR 2 "gpc_reg_operand" "r,r,r")))]
  ""
  "@
   subf %0,%2,%1
   subfic %0,%2,%1
...
(define_insn "andsi3_mc"
  [(set (match_operand:SI 0 "gpc_reg_operand" "=r,r,r,r,r")
	(and:SI (match_operand:SI 1 "gpc_reg_operand" "%r,r,r,r,r")
		(match_operand:SI 2 "and_operand" "?r,T,K,wD,L")))
  ...
  "@
   ...
   andi. %0,%1,%2
   andis. %0,%1,%u2"
  [(set_attr "type" "*,shift,fast_compare,fast_compare,fast_compare")
...
(define_insn "*andsi3_internal2_mc"
  [(set (match_operand:CC 0 "cc_reg_operand" "=x,x,x,x,x,?y,??y,??y,?y")
	(compare:CC (and:SI (match_operand:SI 1 "gpc_reg_operand" "%r,r,r,r,r,r,r,r,r")
			    (match_operand:SI 2 "and_operand" "r,K,wD,L,T,r,K,L,T"))
		    (const_int 0)))
   (clobber (match_scratch:SI 3 "=r,r,r,r,r,r,r,r,r"))
   (clobber (match_scratch:CC 4 "=X,X,X,X,X,X,x,x,X"))]
  ...
  [(set_attr "type" "fast_compare,fast_compare,fast_compare,fast_compare,\
		     delayed_compare,compare,compare,compare,compare")
...
(define_insn "*andsi3_internal3_mc"
  ...
  "@
   ...
   #
   #"
  [(set_attr "type" "compare,fast_compare,fast_compare,fast_compare,\
		     delayed_compare,compare,compare,compare,compare")
   (set_attr "length" "8,4,4,4,4,8,8,8,8")
   (set_attr "cpu_facility" "*,*,vle,*,*,*,*,*,*")])
...
(define_insn "*andsi3_internal4"
  [(set (match_operand:CC 3 "cc_reg_operand" "=x,x,x,x,x,?y,??y,??y,?y")
	(compare:CC (and:SI (match_operand:SI 1 "gpc_reg_operand" "%r,r,r,r,r,r,r,r,r")
			    (match_operand:SI 2 "and_operand" "r,K,wD,L,T,r,K,L,T"))
		    (const_int 0)))
   (set (match_operand:SI 0 "gpc_reg_operand" "=r,r,r,r,r,r,r,r,r")
	(and:SI (match_dup 1)
		(match_dup 2)))
   (clobber (match_scratch:CC 4 "=X,X,X,X,X,X,x,x,X"))]
  "TARGET_32BIT && rs6000_gen_cell_microcode"
...
(define_insn "*iorsi3_internal1"
  [(set (match_operand:SI 0 "gpc_reg_operand" "=r,r,r,r")
	(ior:SI (match_operand:SI 1 "gpc_reg_operand" "%r,0,r,0")
            (match_operand:SI 2 "logical_operand" "r,K,wD,L")))]
  "TARGET_VLE"
  "@
   or %0,%1,%2
   ori %0,%1,%b2
...
(define_insn "*xorsi3_internal1"
  [(set (match_operand:SI 0 "gpc_reg_operand" "=r,r")
	(xor:SI (match_operand:SI 1 "gpc_reg_operand" "%r,r")
	        (match_operand:SI 2 "logical_operand" "r,wD")))]
  "TARGET_VLE"
  "@
   xor %0,%1,%2
   xori %0,%1,%2"
  ...
  "*
{
  ...
  if (which_alternative == 1)
    ...
    if (TARGET_VLE && (size == 1) &&  VLE_REG_P(REGNO(operands[1])))
    {
        /* extract exactly one bit */
        return \"se_btsti %1, %3\";
...
(define_insn "ashlsi3"
  [(set (match_operand:SI 0 "gpc_reg_operand" "=r,r,r")
	(ashift:SI (match_operand:SI 1 "gpc_reg_operand" "0,r,r")
		   (match_operand:SI 2 "reg_or_cint_operand" "r,r,i")))]
  ""
  "@
   slw %0,%1,%2
   slw %0,%1,%2
   slwi %0,%1,%h2"
  [(set_attr "type" "var_shift_rotate,var_shift_rotate,shift")])
...
(define_insn "*adddi3_noppc64"
  [(set (match_operand:DI 0 "gpc_reg_operand" "=&r,&r,&r,r,r,r")
	(plus:DI (match_operand:DI 1 "gpc_reg_operand" "%r,r,r,0,0,0")
		 (match_operand:DI 2 "reg_or_short_operand" "r,I,wD,r,I,wD")))]
  "! TARGET_POWERPC64"
  "*
{
  if (WORDS_BIG_ENDIAN)
...
(define_insn "*subdi3_noppc64"
  [(set (match_operand:DI 0 "gpc_reg_operand"           "=&r,&r,&r,r,r,r,r")
	(minus:DI (match_operand:DI 1 "reg_or_short_operand" "r,I,wD,0,r,I,wD")
		  (match_operand:DI 2 "gpc_reg_operand"          "r,r,r,r,0,0,0")))]
  "! TARGET_POWERPC64"
  "*
{
  if (WORDS_BIG_ENDIAN)
...
;; [GCC-204] change constraint 'y' to 'wy' to satisfy all CR regs
(define_insn "*movcc_internal1"
  [(set (match_operand:CC 0 "nonimmediate_operand" "=wy,x,?wy,wy,r,r,r,r,r,cl,r,m")
	(match_operand:CC 1 "general_operand" "wy,r,r,O,x,wy,r,I,h,r,m,r"))]
  ...
  "*
{
  ...
  [(set_attr "type" "store_n,store_n,load_n,load_n,load_n,load_n")
...
(define_insn "*movsi_update1"
  [(set (match_operand:SI 3 "gpc_reg_operand" "=r,r,r")
	(mem:SI (plus:SI (match_operand:SI 1 "gpc_reg_operand" "0,0,0")
			 (match_operand:SI 2 "reg_or_short_operand" "r,I,wI"))))
...
(define_insn "*movsf_update3"
  [(set (match_operand:SF 3 "gpc_reg_operand" "=r,r,r")
	(mem:SF (plus:SI (match_operand:SI 1 "gpc_reg_operand" "0,0,0")
			 (match_operand:SI 2 "reg_or_short_operand" "r,I,wI"))))
   (set (match_operand:SI 0 "gpc_reg_operand" "=b,b,b")
	(plus:SI (match_dup 1) (match_dup 2)))]
...
{ rtx chain = gen_reg_rtx (Pmode);
  ...
  else if (TARGET_VLE && (INTVAL (operands[1]) < -127
                        || INTVAL (operands[1]) > 128))
     {
        neg_op0 = gen_reg_rtx (Pmode);
        emit_insn(gen_movsi(neg_op0, GEN_INT (- INTVAL (operands[1]))));
     }
  else
...
(define_insn "*cmp<mode>_internal1"
  [(set (match_operand:CC 0 "cc_reg_operand" "=y,y,y,x")
	(compare:CC (match_operand:GPR 1 "gpc_reg_operand" "r,r,r,r")
		    (match_operand:GPR 2 "reg_or_short_operand" "r,I,wD,I")))]
  "!(TARGET_VLE && REGNO(operands[0]) < FIRST_PSEUDO_REGISTER
    && REGNO(operands[0]) != CR0_REGNO && GET_CODE(operands[2]) == CONST_INT
    && !satisfies_constraint_wD(operands[2]))"
  "cmp<wd>%I2 %0,%1,%2"
  [(set_attr "type" "cmp")
   (set_attr "cpu_facility" "*,novle,vle,vle")])
...
(define_peephole2
  ...
  "peep2_reg_dead_p (3, operands[0])
   ...
   && (!TARGET_VLE || ((REGNO(operands[4]) == CR0_REGNO) && REG_P(operands[2])))"
...
(define_insn "*cmpsi_internal2"
  [(set (match_operand:CCUNS 0 "cc_reg_operand" "=y,y,y,x")
	(compare:CCUNS (match_operand:SI 1 "gpc_reg_operand" "r,r,r,r")
		       (match_operand:SI 2 "reg_or_u_short_operand" "r,K,wD,K")))]
  ""
  "@
   cmplw%I2 %0,%1,%b2
   cmplw%I2 %0,%1,%b2
...
(define_insn "*cmptf_internal1"
  ...
  "fcmpu %0,%1,%2\;bne %0,0f\;fcmpu %0,%L1,%L2\;0:\;"
  [(set_attr "type" "fpcompare")
   (set_attr "length" "12")])
...
(define_insn "*plus_eqsi"
  [(set (match_operand:SI 0 "gpc_reg_operand" "=&r,&r,&r,&r,&r,&r,&r")
	(plus:SI (eq:SI (match_operand:SI 1 "gpc_reg_operand" "%r,r,r,r,r,r,r")
			(match_operand:SI 2 "scc_eq_operand" "r,O,K,wD,L,I,wD"))
		 (match_operand:SI 3 "gpc_reg_operand" "r,r,r,r,r,r,r")))]
  "TARGET_32BIT"
  "@
   xor %0,%1,%2\;subfic %0,%0,0\;addze %0,%3
   subfic %0,%1,0\;addze %0,%3
   xori %0,%1,%b2\;subfic %0,%0,0\;addze %0,%3
   xori %0,%1,%2\;subfic %0,%0,0\;addze %0,%3
   xoris %0,%1,%u2\;subfic %0,%0,0\;addze %0,%3
   subfic %0,%1,%2\;subfic %0,%0,0\;addze %0,%3
   subfic %0,%1,%2\;subfic %0,%0,0\;addze %0,%3"
  [(set_attr "type" "three,two,three,three,three,three,three")
   (set_attr "length" "12,8,12,12,12,12,12")
   (set_attr "cpu_facility" "*,*,novle,vle,novle,novle,vle")])

(define_insn "*compare_plus_eqsi"
  [(set (match_operand:CC 0 "cc_reg_operand" "=x,x,x,x,x,x,x,?y,?y,?y,?y,?y,?y")
	(compare:CC
	 (plus:SI
	  (eq:SI (match_operand:SI 1 "gpc_reg_operand" "%r,r,r,r,r,r,r,r,r,r,r,r,r")
		 (match_operand:SI 2 "scc_eq_operand" "r,O,K,wD,L,I,wD,r,O,K,L,I,wD"))
	  (match_operand:SI 3 "gpc_reg_operand" "r,r,r,r,r,r,r,r,r,r,r,r,r"))
	 (const_int 0)))
   (clobber (match_scratch:SI 4 "=&r,&r,&r,&r,&r,&r,&r,&r,&r,&r,&r,&r,&r"))]
  "TARGET_32BIT && optimize_size"
  "@
   xor %4,%1,%2\;subfic %4,%4,0\;addze. %4,%3
   subfic %4,%1,0\;addze. %4,%3
   xori %4,%1,%b2\;subfic %4,%4,0\;addze. %4,%3
   xori %4,%1,%2\;subfic %4,%4,0\;addze. %4,%3
   ...
   #"
  [(set_attr "type" "three,two,three,three,three,three,three,*,*,*,*,*,*")
   (set_attr "length" "12,8,12,12,12,12,12,16,12,16,16,16,16")
   (set_attr "cpu_facility" "*,*,novle,vle,novle,novle,vle,*,*,*,*,novle,vle")])
...
(define_insn "*plus_eqsi_compare"
  [(set (match_operand:CC 4 "cc_reg_operand" "=x,x,x,x,x,x,x,?y,?y,?y,?y,?y,?y")
	(compare:CC
	 (plus:SI
	  (eq:SI (match_operand:SI 1 "gpc_reg_operand" "%r,r,r,r,r,r,r,r,r,r,r,r,r")
		 (match_operand:SI 2 "scc_eq_operand" "r,O,K,wD,L,I,wD,r,O,K,L,I,wD"))
	  (match_operand:SI 3 "gpc_reg_operand" "r,r,r,r,r,r,r,r,r,r,r,r,r"))
	 (const_int 0)))
   (set (match_operand:SI 0 "gpc_reg_operand" "=&r,&r,&r,&r,&r,&r,&r,&r,&r,&r,&r,&r,&r")
  ...
  "@
   ...
   #"
  [(set_attr "type" "three,two,three,three,three,three,three,*,*,*,*,*,*")
   (set_attr "length" "12,8,12,12,12,16,12,16,16,16,16,16,16")
   (set_attr "cpu_facility" "*,*,novle,vle,novle,novle,vle,*,*,*,*,novle,vle")])
...
(define_insn "*leu<mode>"
  [(set (match_operand:P 0 "gpc_reg_operand" "=r,r,r")
	(leu:P (match_operand:P 1 "gpc_reg_operand" "r,r,r")
	       (match_operand:P 2 "reg_or_short_operand" "r,I,wD")))]
  ""
  "@
   subf%I2c %0,%1,%2\;li %0,0\;adde %0,%0,%0
   subf%I2c %0,%1,%2\;li %0,0\;adde %0,%0,%0
   subf%I2c %0,%1,%2\;li %0,0\;adde %0,%0,%0"
  [(set_attr "type" "three,three,three")
   (set_attr "length" "12,12,12")
   (set_attr "cpu_facility" "*,novle,vle")])

(define_insn "*leu<mode>_compare"
  [(set (match_operand:CC 3 "cc_reg_operand" "=x,x,x,?y,?y")
	(compare:CC
	 (leu:P (match_operand:P 1 "gpc_reg_operand" "r,r,r,r,r")
		(match_operand:P 2 "reg_or_short_operand" "r,I,wD,rI,rwD"))
	 (const_int 0)))
   (set (match_operand:P 0 "gpc_reg_operand" "=r,r,r,r,r")
  ...
  "@
   ...
   #"
  [(set_attr "type" "three,three,three,*,*")
   (set_attr "length" "12,12,12,16,16")
   (set_attr "cpu_facility" "*,novle,vle,novle,vle")])
...
(define_insn "*plus_leu<mode>"
  [(set (match_operand:P 0 "gpc_reg_operand" "=&r,&r,&r")
	(plus:P (leu:P (match_operand:P 1 "gpc_reg_operand" "r,r,r")
		       (match_operand:P 2 "reg_or_short_operand" "r,I,wD"))
		(match_operand:P 3 "gpc_reg_operand" "r,r,r")))]
  ""
  "@
...
(define_insn ""
  [(set (match_operand:CC 0 "cc_reg_operand" "=x,x,x,?y,?y")
	(compare:CC
	 (plus:SI (leu:SI (match_operand:SI 1 "gpc_reg_operand" "r,r,r,r,r")
			  (match_operand:SI 2 "reg_or_short_operand" "r,I,wD,rI,rwD"))
...
(define_insn ""
  [(set (match_operand:CC 4 "cc_reg_operand" "=x,x,x,?y,?y")
	(compare:CC
	 (plus:SI (leu:SI (match_operand:SI 1 "gpc_reg_operand" "r,r,r,r,r")
			  (match_operand:SI 2 "reg_or_short_operand" "r,I,wD,rI,rwD"))
		  (match_operand:SI 3 "gpc_reg_operand" "r,r,r,r,r"))
...
(define_insn "*neg_leu<mode>"
  [(set (match_operand:P 0 "gpc_reg_operand" "=r,r,r")
	(neg:P (leu:P (match_operand:P 1 "gpc_reg_operand" "r,r,r")
		      (match_operand:P 2 "reg_or_short_operand" "r,I,wD"))))]
  ""
  "@
...
(define_insn ""
  [(set (match_operand:CC 0 "cc_reg_operand" "=x,x,x,?y,?y")
	(compare:CC
	 (and:SI (neg:SI
		  (leu:SI (match_operand:SI 1 "gpc_reg_operand" "r,r,r,r,r")
			  (match_operand:SI 2 "reg_or_short_operand" "r,I,wD,rI,rwD")))
		 (match_operand:SI 3 "gpc_reg_operand" "r,r,r,r,r"))
	 (const_int 0)))
   (clobber (match_scratch:SI 4 "=&r,&r,&r,&r,&r"))]
...
(define_insn "*neg_ltu<mode>"
  [(set (match_operand:P 0 "gpc_reg_operand" "=r,r,r")
	(neg:P (ltu:P (match_operand:P 1 "gpc_reg_operand" "r,r,r")
		      (match_operand:P 2 "reg_or_neg_short_operand" "r,P,wP"))))]
  ""
  "@
...
(define_insn "*geu<mode>_compare"
  [(set (match_operand:CC 3 "cc_reg_operand" "=x,x,x,?y,?y,?y")
	(compare:CC
	 (geu:P (match_operand:P 1 "gpc_reg_operand" "r,r,r,r,r,r")
		(match_operand:P 2 "reg_or_neg_short_operand" "r,P,wP,r,P,wP"))
	 (const_int 0)))
   (set (match_operand:P 0 "gpc_reg_operand" "=r,r,r,r,r,r")
  ...
  "@
   ...
   #"
  [(set_attr "type" "three")
   (set_attr "length" "12,12,12,16,16,16")
   (set_attr "cpu_facility" "*,novle,vle,*,novle,vle")])
...
(define_insn "*plus_geu<mode>"
  [(set (match_operand:P 0 "gpc_reg_operand" "=&r,&r,&r")
	(plus:P (geu:P (match_operand:P 1 "gpc_reg_operand" "r,r,r")
		       (match_operand:P 2 "reg_or_neg_short_operand" "r,P,wP"))
		(match_operand:P 3 "gpc_reg_operand" "r,r,r")))]
  ""
  "@
...
(define_insn ""
  [(set (match_operand:CC 0 "cc_reg_operand" "=x,x,x,?y,?y,?y")
	(compare:CC
	 (plus:SI (geu:SI (match_operand:SI 1 "gpc_reg_operand" "r,r,r,r,r,r")
			  (match_operand:SI 2 "reg_or_neg_short_operand" "r,P,wP,r,P,wP"))
  ...
  "@
   ...
   #"
  [(set_attr "type" "three")
   (set_attr "length" "8,8,8,12,12,12")
   (set_attr "cpu_facility" "*,novle,vle,*,novle,vle")])
...
(define_insn "*neg_gtu<mode>"
  [(set (match_operand:P 0 "gpc_reg_operand" "=r,r,r")
	(neg:P (gtu:P (match_operand:P 1 "gpc_reg_operand" "r,r,r")
		      (match_operand:P 2 "reg_or_short_operand" "r,I,wD"))))]
  ""
  "@
...
(define_insn "naked_return"
  ...
  ""
  "# Naked function: return provided by programmer."
)
...
(define_expand "ctrap<mode>4"
  ...
  "
  {
    if (GET_CODE(operands[2]) == CONST_INT && TARGET_VLE)
    {
        rtx reg = force_reg (GET_MODE(operands[1]), operands[2]);
        operands[2] = reg;
    }
  }
  ")
...
(define_insn "*movesi_from_cr_one"
  [(match_parallel 0 "mfcr_operation"
		   [(set (match_operand:SI 1 "gpc_reg_operand" "=r")
			 (unspec:SI [(match_operand:CC 2 "cc_reg_operand" "wy")
...
(define_insn "*movsi_to_cr"
  [(match_parallel 0 "mtcrf_operation"
		   [(set (match_operand:CC 1 "cc_reg_operand" "=wy")
...
(define_insn "*mtcrfsi"
  [(set (match_operand:CC 0 "cc_reg_operand" "=wy")
        (unspec:CC [(match_operand:SI 1 "gpc_reg_operand" "r")
...
(define_insn "movsi_pic"
  [(set (match_operand:SI 0 "register_operand" "=&r")
        (unspec:SI [(match_operand:SI 1 "pic_no_const_operand" "")
                    ] UNSPEC_CODE_PIC_ADDR))
   (use (match_operand:SI 2 "register_operand" "r"))
 ]
 "TARGET_CODE_PIC && TARGET_PIC_DYNAMIC_ADDR_CALC"
 "lis %0,%1@ha\;la %0, %1@l(%0) # load pic\;subf %0,%2,%0"
 [(set_attr "type" "three")])

(define_insn "load_offset_pic_reg"
 [(set (match_operand:SI 0 "register_operand" "=&r")
     (unspec  [(const_int 0)] UNSPEC_CODE_PIC_ADDR))
  (clobber (reg:SI LR_REGNO))
  (clobber (match_scratch:SI 1 "=&r"))]
 "TARGET_CODE_PIC && TARGET_32BIT && TARGET_PIC_DYNAMIC_ADDR_CALC"
 "bl 0f\;0:\;mflr %1\;lis %0, 0b@ha\;la %0,0b@l(%0)\;subf %0,%1,%0 # set offset reg %0"
 [(set_attr "type" "branch")
 (set_attr "length" "20")])

(define_insn "subsi3_pic"
  [(set (match_operand:SI 0 "gpc_reg_operand" "=r")
        (unspec:SI [ (match_operand:SI 1 "gpc_reg_operand" "r")
                  (match_operand:SI 2 "gpc_reg_operand" "r") ] UNSPEC_CODE_PIC_ADDR))]
  "TARGET_CODE_PIC && TARGET_32BIT && TARGET_PIC_DYNAMIC_ADDR_CALC"
  "subf %0,%2,%1"
  [(set_attr "type" "integer")])
